...
@dataclass
class RLCMTrainConfig:
    # config = ml_collections.ConfigDict()
    # TODO: Delete unused configs for RLCM
    ###### General ######
    ...
    pretrained_model: str = "SimianLuo/LCM_Dreamshaper_v7"
    ...
    # train_gradient_accumulation_steps: int = 32
    train_gradient_accumulation_steps: int = 2
    # maximum gradient norm for gradient clipping.
    train_max_grad_norm: float = 5.0
