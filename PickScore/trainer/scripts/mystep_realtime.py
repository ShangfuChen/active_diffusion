...
# TODO #
# Use images to update the reward model
# args
#   - images: tensor images
#   - reward_model: automodel(PickScore_v1) 
# return
#   - rewards
#   - reward_model
def reward_train_step(images, reward_model):
    return torch.zeros(images.shape), reward_model
