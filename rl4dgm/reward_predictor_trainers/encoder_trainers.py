...
from rl4dgm.models.my_models import LinearModel, CNNModel
...
class EntropyEncoderTrainer:
    def __init__(
        ...
        Args:
            ...
            trainset and testset (XentropyDataset) : datasets to use for training and testing. See XentropyDataset class for more detail
            config_dict : 
                keys: batch_size, shuffle, lr, n_epochs, save_dir, save_every
        """
        default_config = {
            "batch_size" : 32,
            "shuffle" : True,
