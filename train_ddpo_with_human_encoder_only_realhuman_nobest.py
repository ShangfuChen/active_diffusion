...
from rl4dgm.models.mydatasets import TripletDatasetWithPositiveNegative, HumanDatasetSimilarity
...
def main(cfg: TrainerConfig) -> None:
    ...
    while n_ddpo_train_calls < cfg.ddpo_conf.n_outer_loops:
        ...
        if human_dataset.n_data >= n_human_data_for_training:
            ...
            human_encoder_trainset = TripletDatasetWithPositiveNegative(
