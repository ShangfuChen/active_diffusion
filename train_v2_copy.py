...
ddpo.init(cfg.ddpo) # initialize model, optimizer, dataloaders, accelerator
reward_model.init(cfg.reward) # initialize model, optimizer, dataloaders, accelerator
...
def train_ddpo(config):
    ...
    ##################################################################
    ############## This should happen in initialization ##############
    ##################################################################
